...
from NetFL_staff_test import mk_msg
...
#       tsrc tsink src  dest opaque payload
    [ ( 0x1, 0x1,  i,   i,   0x00,  0xfe ), # deliver directly
      ( 0x0, 0x1,  i,   i,   0x01,  0xee ), # deliver directly
      ( 0x2, 0x1,  i,   i,   0x02,  0xde ), # deliver directly

      ( 0x0, 0x2,  pre, nxt, 0x03,  0xce ), # pass it through
      ( 0x0, 0x2,  nxt, pre, 0x04,  0xbe ), # pass it through
      ( 0x2, 0x0,  pre, nxt, 0x05,  0xae ), # pass it through

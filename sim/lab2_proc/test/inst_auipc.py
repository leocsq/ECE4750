...
def gen_dest_dep_test():
  return [
    ...
    gen_imm_dest_dep_test( 3, "auipc",   0x00001234,  0x01230000 + 0x200 + 13*4 ),
    gen_imm_dest_dep_test( 2, "auipc",   0x01234000,  0x34000000 + 0x200 + 18*4 ),
    gen_imm_dest_dep_test( 1, "auipc",   0x12344321,  0x44321000 + 0x200 + 22*4 ),
    gen_imm_dest_dep_test( 0, "auipc",   0x44321000,  0x21000000 + 0x200 + 25*4 ),
  ]
...
def gen_value_test():
  return [
    ...
    gen_imm_value_test( "auipc", 0xffffff21, 0xfff21000 + 0x200 + 14*4 ),
    ...
    gen_imm_value_test( "auipc", 0xffff0005, 0xf0005000 + 0x200 + 22*4 ),
    gen_imm_value_test( "auipc", 0xffffff15, 0xfff15000 + 0x200 + 24*4 ),
    gen_imm_value_test( "auipc", 0xffff0025, 0xf0025000 + 0x200 + 26*4 ),  
  ]
#-------------------------------------------------------------------------
# gen_random_test
#-------------------------------------------------------------------------

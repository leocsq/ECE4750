...
def gen_dest_dep_test():
  return [
    gen_imm_dest_dep_test( 5, "lui",   0x00000003,  0x00000300),
    gen_imm_dest_dep_test( 4, "lui",   0x00003000,  0x03000000),
    gen_imm_dest_dep_test( 3, "lui",   0x00001234,  0x01234000),
    gen_imm_dest_dep_test( 2, "lui",   0x01234000,  0x34000000),
    gen_imm_dest_dep_test( 1, "lui",   0x12344321,  0x44321000),
    gen_imm_dest_dep_test( 0, "lui",   0x44321000,  0x21000000),
  ]
...
def gen_value_test():
  return [
    ...
    gen_imm_value_test( "lui", 0xffffff21, 0xfff21000 ),
    ...
    gen_imm_value_test( "lui", 0xffff0005, 0xf0005000 ),
    gen_imm_value_test( "lui", 0xffffff15, 0xfff15000 ),
    gen_imm_value_test( "lui", 0xffff0025, 0xf0025000 ),  
  ]
#-------------------------------------------------------------------------
# gen_random_test
#-------------------------------------------------------------------------

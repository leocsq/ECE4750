...
sim     = sim_dir + os.path.sep + 'proc-sim-staff'

# Print header

print ""
print " Results from running simulator with mem-latency = 2 and mem-dprob = 0.5"
print ""
...
for eval_run in eval_runs:
  ...
  cmd = [ sim, "--impl", impl, "--input", input_, "--stats", "--verify",
          "--max-cycles",  "100000", "--mem-latency", "2", "--mem-dprob", "0.5" ]

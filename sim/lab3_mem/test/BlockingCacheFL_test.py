...
def fully_used_all_cache_lines_asso( base_addr ):
  return [
    ...
    req( 'rd', 0x1d, 0x00000065, 0, 0          ), resp('rd', 0x1d, 1, 0,   0x63334444   ), 
    req( 'rd', 0x1e, 0x00000070, 0, 0          ), resp('rd', 0x1e, 1, 0,   0xdeadbeef   ),
    req( 'rd', 0x20, 0x00000075, 0, 0          ), resp('rd', 0x20, 1, 0,   0x73334444   ), 
    req( 'rd', 0x21, 0x00000080, 0, 0          ), resp('rd', 0x21, 1, 0,   0xdeadbeef   ),
    req( 'rd', 0x22, 0x00000085, 0, 0          ), resp('rd', 0x22, 1, 0,   0x83334444   ), 
    req( 'rd', 0x23, 0x00000090, 0, 0          ), resp('rd', 0x23, 1, 0,   0xdeadbeef   ),
    req( 'rd', 0x24, 0x00000095, 0, 0          ), resp('rd', 0x24, 1, 0,   0x93334444   ), 
    req( 'rd', 0x25, 0x000000a0, 0, 0          ), resp('rd', 0x25, 1, 0,   0xdeadbeef   ),
    req( 'rd', 0x26, 0x000000a5, 0, 0          ), resp('rd', 0x26, 1, 0,   0xa3334444   ), 
    req( 'rd', 0x27, 0x000000b0, 0, 0          ), resp('rd', 0x27, 1, 0,   0xdeadbeef   ),
    req( 'rd', 0x28, 0x000000b5, 0, 0          ), resp('rd', 0x28, 1, 0,   0xb3334444   ), 
    req( 'rd', 0x29, 0x000000c0, 0, 0          ), resp('rd', 0x29, 1, 0,   0xdeadbeef   ),
    req( 'rd', 0x2a, 0x000000c5, 0, 0          ), resp('rd', 0x2a, 1, 0,   0xc3334444   ), 
    req( 'rd', 0x2b, 0x000000d0, 0, 0          ), resp('rd', 0x2b, 1, 0,   0xdeadbeef   ),
    req( 'rd', 0x2c, 0x000000d5, 0, 0          ), resp('rd', 0x2c, 1, 0,   0xd3334444   ), 
    req( 'rd', 0x2d, 0x000000e0, 0, 0          ), resp('rd', 0x2d, 1, 0,   0xdeadbeef   ),
    req( 'rd', 0x2e, 0x000000e5, 0, 0          ), resp('rd', 0x2e, 1, 0,   0xe3334444   ), 

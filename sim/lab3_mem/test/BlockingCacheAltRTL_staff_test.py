...
from BlockingCacheFL_staff_test import test_case_table_generic
from BlockingCacheFL_staff_test import test_case_table_set_assoc
from BlockingCacheFL_staff_test import TestHarness

from lab3_mem.BlockingCacheAltRTL import BlockingCacheAltRTL

# We import tests defined in BlockingCacheFL_staff_test.py. The idea is we can
...
#'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''\/
from BlockingCacheFL_staff_test import test_case_table_enhanced_random
...
def test_enhanced_random( test_params, dump_vcd ):
  ...
  msgs = test_params.msg_func( 0, 256, 2, test_params.nbank, 16, mem )
  # Instantiate testharness
  harness = TestHarness( msgs[::2], msgs[1::2],
                         test_params.stall, test_params.lat,
                         test_params.src, test_params.sink,
